...
public class GridProduct {
        ...
        }; //made the grid from Project Euler #11, but made the program so any grid AxA can be evaluated the same

        public GridProduct(){
            System.out.println(getProduct());
        }

        public int getProduct(){ //brings all the methods together and finds the greatest product from them
         ...
         //checking both right and left diagonals
        public int diagonalProduct(int[][] grid){
         ...
         //horizontal products of all combinations
        public int horizontalProduct(int[][] grid){
            int product = 0;
         ...
         //vertical products of all combinations
        public int verticalProduct(int[][] grid){
            int product = 0;
        ...
        public static void main(String[] args){
            GridProduct gridProd = new GridProduct();
        }
    }
